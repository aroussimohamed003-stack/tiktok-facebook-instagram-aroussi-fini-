...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['content'])) {
    ...
    $sql = "INSERT INTO posts (user_id, content, image_path, privacy) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    if ($stmt) {
        $stmt->bind_param("isss", $user_id, $content, $image_path, $privacy);
        if ($stmt->execute()) {
            // Success
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-2">
                    <select name="privacy" class="form-select form-select-sm" style="width: auto; border-radius: 20px;">
