...
<div class="main-container">
  <div class="upload-card">
    ...
    <form id="uploadForm">
      ...
      <div class="mb-4">
        <label for="privacy" class="form-label">الخصوصية (Privacy)</label>
        <select class="form-select form-control" id="privacy">
          <option value="public">عام (الكل يمكنه المشاهدة)</option>
          <option value="private">خاص (الأصدقاء فقط)</option>
        </select>
      </div>
