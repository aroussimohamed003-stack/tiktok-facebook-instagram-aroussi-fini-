...
.profile-videos {
    display: grid;
    grid-template-columns: repeat(2, 1fr); /* 2 Columns for better visibility on mobile */
    gap: 8px;
}
                    ...
                    ?>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="profile.php?user_id=<?= $s['id'] ?>" class="d-flex align-items-center text-decoration-none text-white overflow-hidden">
                                <img src="<?= $s_pic ?>" class="rounded-circle me-2" style="width:35px;height:35px;object-fit:cover; flex-shrink:0;">
                                <span style="font-size: 13px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100px;"><?= htmlspecialchars($s['username']) ?></span>
                            </a>
