...
<head>
    ...
    <title>Welcome to Piqosocial - Login & Join</title>
    <!-- Tailwind CSS v3 -->
        ...
        <div class="hidden md:flex md:w-1/2 lg:w-3/5 bg-slate-900 relative overflow-hidden items-center justify-center p-12">
            ...
            <div class="relative z-10 max-w-lg text-white">
                <div class="mb-8 animate-float">
                    <img src="logo.png" alt="Piqosocial" class="w-24 h-24 mb-6 brightness-0 invert" onerror="this.src='src/img/logo.png'">
        ...
        <div class="flex-1 flex flex-col justify-center p-6 sm:p-12 lg:p-20 bg-white">
            <div class="max-w-md w-full mx-auto">
                ...
                <div class="md:hidden flex flex-col items-center mb-10">
                    <img src="logo.png" alt="Piqosocial" class="w-16 h-16 mb-4" onerror="this.src='src/img/logo.png'">
                    <h2 class="text-3xl font-bold font-brand text-slate-900 tracking-tight">Piqosocial</h2>
                </div>
                ...
                <div class="mt-12 pt-8 border-t border-slate-50 flex flex-col items-center gap-6">
                    ...
                    <p class="text-[10px] text-slate-400 font-medium">© <?= date('Y') ?> PIQOSOCIAL TECHNOLOGY CORP.</p>
                </div>
            </div>
        </div>
    </div>
