  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title ab" id="loginModalLabel">register</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="إغلاق"></button>
      </div>
      <div class="modal-body">
        <p class="ab">يجب تسجيل الدخول لمشاهدة الفيديوات و تتمكن من رفع فيديو و كثير من مميزات.</p>
...
<script>
    // إظهار التنبيه بعد 5 ثوانٍ
    setTimeout(function() {
        alert("📹 إذا أعجبك فكرة استضافة موقع يمكنك رفع فديواتك على موقع و سأزيل فديوات خاص بي و نتضرو مميزات في موقع");
    }, 9770); // 5000 ملي ثانية (5 ثوانٍ)
</script>
...
<script>
  setTimeout(function() {
    ...
    loginModal.show();
  }, 10000); // 10 ثوانٍ (10000 ميلي ثانية)
</script>

<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="b77807ea-9634-4c37-bfb3-c57fb667bcf5";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
