...
// Add remember_token and email to users table
mysqli_query($con, "ALTER TABLE users ADD COLUMN IF NOT EXISTS remember_token VARCHAR(255) NULL");
mysqli_query($con, "ALTER TABLE users ADD COLUMN IF NOT EXISTS email VARCHAR(255) NULL");
        ...
        <div class="col-lg-6 col-md-12">
            ...
            <div class="mb-4" style="position: relative; z-index: 1;">
                <form action="search_users.php" method="GET" class="px-2">
                    <div class="input-group" style="box-shadow: 0 4px 15px rgba(0,0,0,0.3); border-radius: 50px; overflow: hidden; border: 2px solid #ffffff;">
                            ...
                            <div class="video-container">
                                ...
                                <div class="video-footer">
                                    <div class="d-flex align-items-center mb-2">
                                        <img src="<?= $display_profile_picture ?>" class="profile-img" onerror="this.src='uploads/profile.jpg'">
                                        <span class="profile-link" onclick="showProfile(<?= $video_owner_id ?>, '<?= addslashes($username) ?>', '<?= $display_profile_picture ?>')"><?= htmlspecialchars($username) ?></span>
                                    </div>
