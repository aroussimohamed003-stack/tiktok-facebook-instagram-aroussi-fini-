    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" style="z-index: 10010;">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link" href="public.php"><i class="fas fa-globe"></i> فيديوهات عامة</a>
          </li>
          <li class="nav-item">
...
<div class="mobile-bottom-nav d-md-none">
  <div class="mobile-bottom-nav-icons">
    ...
    <a href="public.php" class="mobile-bottom-nav-icon <?php echo basename($_SERVER['PHP_SELF']) == 'public.php' ? 'active' : ''; ?>">
      <i class="fas fa-globe"></i>
      <span>videos public</span>
    </a>
        ...
        .then(data => {
            ...
            if (!data.notifications || data.notifications.length === 0) {
                ...
                data.notifications.forEach(n => {
                    ...
                    var link = '#';
                    if(n.type == 'message') {
                        if(n.msg_type == 'market') link = 'market_messages.php';
                        else link = 'message.php';
                    }
