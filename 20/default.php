...
<html lang="ar">
    ...
    <body>
        ...
        <div class="content">
            ...
            <h1>لقد أصبحت جاهزا للبدء!</h1>
            <p>كل ما عليك فعله الآن هو تحميل ملفات موقعك الإلكتروني وبدء رحلتك. تحقق من كيفية القيام بذلك أدناه:</p>
            <div class="link-container">
                <a 
                    ...
                    target="_blank"
                >
                    كيف يمكنني نقل موقع إلكتروني إلى Hostinger؟ 
                ...
                <a 
                    ...
                    target="_blank"
                >
                    كيف أقوم بتثبيت ووردبريس باستخدام برنامج التثبيت التلقائي؟
                    <svg class="ic-launch" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path 
                            fill-rule="evenodd" 
                            clip-rule="evenodd" 
